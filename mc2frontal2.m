function d2 = mc2frontal(d, m1, m2, method, rootmarker)
...
%
% Edited by Kristian Nymoen 2020, to allow rotation to a specified root marker rather than centroid
...
elseif strcmp(method, 'frame')
    ...
    for k=1:size(dat,1)
        ...
        if rootmarker
            dat2(k,:) = mcrotate2(dat(k,:), 180-180*th/pi, [0 0 1],[0.5*(x1+x2) 0.5*(y1+y2) 0],rootmarker);
        else
